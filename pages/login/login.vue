<template>
	<div class="app">
		<div class="logo" :style="{paddingTop:padding+'rpx' }">
			<button v-if="type == false" color="#333333" class="logo_phone_but" plain type="default"
				style="border: none;" @click="conversion()">验证码登录</button>
			<button v-else="type == true" color="#333333" class="logo_phone_but" plain type="default"
				style="border: none;" @click="conversion()">密码登录</button>
			<view class="logo_img">
			...
			<div class="logo_div">
				...
				<div class="logo_div_title" v-if="type == false">
					<div>密码</div>
					<div class="logo_div1">
						<input class="logo_div_input" maxlength="15" placeholder="请输入密码" v-model="val.passWord" />
						<i class="progressBar"></i>
					</div>
				</div>
				<div class="logo_div_title" v-else="type == true">
					<div>短信验证码</div>
					<div class="logo_div1">
						<input class="logo_div_input" placeholder="请输入短信验证码" v-model="val.code"
							style="display: inline-block;" />
						<button color="#5563ED" @click="codeClick()" class="code" size='small'
							style="line-height: 48rpx;" type="default">{{ code }}</button>
						<i class="progressBar"></i>
					</div>
				</div>
